        ...
        <form action="{{route('admin.team.update', $team->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-lg-8 col-md-4 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <label class="form-label">Position</label><br><br>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <div class="form-group">
                            <img src="{{Storage::url('team/'.$team->image)}}" id="image-imgsrc" class="img-responsive">
                        ...
                        <a href="{{route('admin.team.index')}}" class="btn btn-danger btn-lg m-t-15 waves-effect">
