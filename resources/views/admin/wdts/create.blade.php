...
@section('content')
    ...
    <div class="row clearfix">
        <form action="{{route('admin.wdts.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
                ...
                <div class="body">
                    ...
                    <div class="row">
                        <div class="form-check form-check-inline col-md-4">
                            <input class="form-check-input" type="radio" name="size" id="small" value="s">
                        ...
                        <div class="form-check form-check-inline col-md-4">
                            <input class="form-check-input" type="radio" name="size" id="xxl" value="xxl">
                            <label class="form-check-label" for="xxl">XX-Large</label>
                        </div>
                    </div>
                </div>
            </div>
