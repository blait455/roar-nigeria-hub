                ...
                <div class="col-lg-8 pl-70 md-pl-15">
                    <div class="contact-widget">
                       <div class="sec-title2 mb-40">
                           <span class="sub-text contact mb-15">Register</span>
                           <h2 class="title testi-title">Register Form</h2>
                        ...
                        <form id="contact-us" method="post" action="{{ route('register') }}">
                            ...
                            <fieldset>
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 mb-30 col-md-6 col-sm-6">
                                        <input class="from-control" type="password" id="phone" name="password" placeholder="Password" required="">
                                    </div>
                                    <div class="col-lg-8 mb-30 col-md-6 col-sm-6">
                                        <input class="from-control" type="password" id="phone" name="password_confirmation" placeholder="Password" required="">
                                    </div>
                                </div>
                                <div class="btn-part">
                                ...
                                <span>Have an account?  <a href="{{ route('login') }}">Login here</a></span>
